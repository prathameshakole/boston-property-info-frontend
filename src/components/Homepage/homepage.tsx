...
//               sx={{ ml: 1, flex: 1 }}
//               placeholder={
//                 searchMode === 'address' ? 'Enter address' : 'Enter owner name'
//               }
...
//               </List>
//             ) : (
//               // Only show the "no results" message if a search has been executed.
//               hasSearched && (
//                 <Box sx={{ p: 2, textAlign: 'center' }}>
//                   <Typography variant="h6" color="textSecondary">
//                     Oops! We couldn't find any matching results.
//                   </Typography>
